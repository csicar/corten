...
\begin{frame}
  ...
  \begin{tikzpicture}[x=1pt, y=1pt, remember picture]
    ...
    \node[help lines, minimum size=40] (rust_character) at (160, 0) {};
    \node[help lines, minimum size=40] (haskell_character) at (-160, 0) {};
...
\begin{frame}{Beispielinhalt: Literatur}
    Literaturzitat: \cite{erdin_verication_nodate}
\end{frame}
