...
\begin{listing}[ht]
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \begin{minted}[autogobble, fontsize=\footnotesize]{rust}
    #[lr::sig(fn(i32<@n>) 
      -> bool<0 < n>)]
...
\[\forall n : \text{int}, \rho : \text{loc} 
  \text{ fn}\left(n > 0, 
    x.\{ \rho \mapsto \text{nat}_{\tau}\langle n \rangle, v \mapsto \text{prt}(\rho)\}
    \rightarrow 
    \rho_0. \{\rho_0 \mapsto \tau, \rho \mapsto \text{nat}_{\tau}\langle n - 1 \rangle \}
    \right)
\]

Corten encode the function as:
