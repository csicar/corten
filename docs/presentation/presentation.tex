    ...
    \only<1-2>{
      \begin{itemize}
        ...
        \begin{itemize}
          ...
          \item observation: assignment can not invalidate existing predicates
        \end{itemize}
      \end{itemize}
    }
    \only<3>{
...
\begin{frame}[fragile]{References -- Strong Updates}
  \begin{columns}
    ...
    \only<3>{ \inputminted[highlightlines=3]{rust}{./snippets/strong-updates.rs} }
    \only<4>{ \inputminted[highlightlines=4]{rust}{./snippets/strong-updates.rs} }
    \only<5>{ \inputminted[highlightlines=7]{rust}{./snippets/strong-updates.rs} }
